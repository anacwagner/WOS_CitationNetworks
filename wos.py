...
###### AVISO ###### 
# ALTERAR O FORMATO DO DATA FRAME "CITATIONS" PARA FICAR SIMILAR A "VAR_CIT" (TESE WALTER), UTILIZADA EM OUTRO REPOSITÓRIO.
# O RESULTADO OBTIDO AQUI NÃO ESTÁ ERRADO, APENAS COM ESTRUTURA DIFERENTE PARA ANÁLISES POSTERIORES. 
# A ALTERARAÇÃPO DEVERÁ OCORRER NA LINHA 384! SERÁ PRECISO COLETAR ALGUMAS INFORMAÇÕES ADICIONAIS.
###### AVISO ######
